 ...
 * File Name=show-device.js
 * Description: Below code will show complete details of device via API
 */
...
async function ShowDevice(){
    ...
    api.devicesV2Show(id, opts).then(function(data) {
      console.log('Device Data Listed successfully. Returned data: ' + util.inspect(data));
    }, function(error) {
      console.error(error);
    });
}
